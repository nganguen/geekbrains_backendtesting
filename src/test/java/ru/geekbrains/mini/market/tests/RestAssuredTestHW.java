...
public class RestAssuredTestHW {
    ...
    public void createPositiveTest() {
        Product p = new Product(null, "Bacon", 10, "Food");
        given()
    ...
    public void createNegativeTest() {
        Product p = new Product(null, "Bacon", 10, "Flowers");
        given()
                .spec(requestSpecification)
                .body(p)
                .when()
        ...
        p = new Product(null, null, 10, "Food");
        given()
                .spec(requestSpecification)
                .body(p)
                .when()
    ...
    public void updatePositiveTest() {
        Product p = new Product(1L, "Bread", 10, "Food");
        given()
                .spec(requestSpecification)
                .body(p)
    ...
    public void updateNegativeTest() {
        Product p = new Product(100L, "Bread", 10, "Food");
        given()
                .spec(requestSpecification)
                .body(p)
                .put("market/api/v1/products")
        ...
        System.out.println("---------Next request-------");
        p = new Product(null, "Bread", 10, "Food");
        given()
                .spec(requestSpecification)
                .body(p)
                .when()
